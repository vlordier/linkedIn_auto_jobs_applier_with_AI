...
class LinkedInEasyApplier:
    def __init__(self, driver: Any, resume_dir: Optional[str], set_old_answers: List[Tuple[str, str, str]], gpt_answerer: Any, resume_generator_manager: Any) -> None:
    ...
    def _save_questions_to_json(self, question_data: Dict[str, Any]) -> None:
        output_file = "answers.json"
